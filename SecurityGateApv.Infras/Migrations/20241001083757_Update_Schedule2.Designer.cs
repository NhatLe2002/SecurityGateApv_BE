...
namespace SecurityGateApv.Infras.Migrations
{
    ...
    [Migration("20241001083757_Update_Schedule2")]
    partial class Update_Schedule2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SecurityGateApv.Domain.Models.CredentialCardType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "Occaecati quasi sunt et reiciendis voluptas dolore.",
                            Status = true
                        },
                        new
                        {
                            ...
                            Description = "Fugit iure eum facere sequi quod a modi enim.",
                            Status = true
                        });
                });
            ...
            modelBuilder.Entity("SecurityGateApv.Domain.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "Voluptatem officiis doloribus modi recusandae vel.",
                        ...
                        new
                        {
                            ...
                            Description = "Fuga assumenda reiciendis molestiae et voluptatem ut.",
                            UpdatedDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Description = "Aperiam veritatis sunt sit autem voluptatum dolores.",
                            UpdatedDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Description = "Quia ut dolore placeat non quibusdam non voluptates autem consequuntur.",
                            UpdatedDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Description = "Voluptas aut praesentium.",
                            UpdatedDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DepartmentName = "Phòng Nhân sự",
                            Description = "Nostrum consectetur et ullam omnis officiis illum praesentium consequuntur exercitationem.",
                            UpdatedDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DepartmentName = "Phòng R&D",
                            Description = "Quo sit harum laboriosam accusantium aut ipsa numquam aut.",
                            UpdatedDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Description = "Quia pariatur numquam illo autem qui quia molestiae porro laboriosam.",
                            UpdatedDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DepartmentName = "Phòng Sản xuất",
                            Description = "At cupiditate nulla et officia vero molestiae cum consectetur.",
                            UpdatedDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DepartmentName = "Phòng R&D",
                            Description = "Consequatur aut ex similique aut aliquid id aut rerum.",
                            UpdatedDate = new DateTime(2024, 9, 29, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
